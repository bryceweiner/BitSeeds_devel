...
# also add new translations to src/qt/BitSeeds.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/BitSeeds_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/BitSeeds-qt.rc
...
windows:RC_FILE = src/qt/res/BitSeeds-qt.rc
...
macx:ICON = src/qt/res/icons/BitSeeds.icns
macx:TARGET = "BitSeeds-Qt"
