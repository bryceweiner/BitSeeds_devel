...
static bool GetKernelStakeModifier(uint256 hashBlockFrom, uint64_t& nStakeModifier, int& nStakeModifierHeight, int64_t& nStakeModifierTime, bool fPrintProofOfStake)
{
    ...
    if (fDebug) printf("GetKernelStakeModifier: Before nStakeModifier=%d\n",nStakeModifier);
    if (fDebug) printf("GetKernelStakeModifier: nStakeModifierTime=%d\n",nStakeModifierTime);
    if (fDebug) printf("GetKernelStakeModifier: nStakeModifierSelectionInterval=%d\n",nStakeModifierSelectionInterval);
    ...
    nStakeModifier = pindex->nStakeModifier;
    if (fDebug) printf("GetKernelStakeModifier: After nStakeModifier=%d\n",nStakeModifier);
    return true;
}
...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock& blockFrom, unsigned int nTxPrevOffset, const CTransaction& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, uint256& targetProofOfStake, bool fPrintProofOfStake)
{
    ...
    if (fDebug) printf("CheckStakeKernelHash: getting kernel stake modifier.\n");
